...
class RedisStore(CacheStore[T], Component[RedisStoreConfig]):
    ...
    component_provider_override = "sunagent_ext.cache_store.redis.RedisStore"

    def __init__(self, redis_instance: redis.Redis, expire: Optional[int] = None):
    ...
    def set(self, key: str, value: T) -> None:
        self.cache.set(key, cast(Any, value), ex=self.expire)
