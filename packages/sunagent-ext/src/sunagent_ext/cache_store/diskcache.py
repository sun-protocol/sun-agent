...
class DiskCacheStore(CacheStore[T], Component[DiskCacheStoreConfig]):
    ...
    See :class:`~sunagent_ext.models.cache.ChatCompletionCache` for an example of usage.
    ...
    component_provider_override = "sunagent_ext.cache_store.diskcache.DiskCacheStore"
    ...
    def delete(self, key: str) -> None:
        self.cache.delete(key)  # type: ignore[reportUnknownMemberType]
