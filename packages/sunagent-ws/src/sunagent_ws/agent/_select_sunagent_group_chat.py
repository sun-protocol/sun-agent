...
from autogen_agentchat.messages import AgentEvent, BaseAgentEvent, ChatMessage, MultiModalMessage
...
class SelectorGroupChatManager(BaseGroupChatManager):
    ...
    async def select_speaker(self, thread: List[AgentEvent | ChatMessage]) -> str:
        ...
        # 如果上一个是pump 在这里直接选择format 为下一个
        if self._previous_speaker is not None and self._previous_speaker == "pump":
            return "format"
        ...
        trace_logger.info(f"Selected speaker: {agent_name} ")
        trace_logger.info(f"Selected spend: {datetime.datetime.now() - start} ")
        return agent_name
...
class SelectorSunagentGroupChat(BaseGroupChat, Component[SelectorGroupChatConfig]):
    ...
    A team with multiple participants:
        ...
        .. code-block:: python
            ...
            from sunagent_agentchat.teams import SelectorGroupChat
            from sunagent_agentchat.conditions import TextMentionTermination
    ...
    A team with a custom selector function:
        ...
        .. code-block:: python
            ...
            from sunagent_agentchat.conditions import TextMentionTermination
            from sunagent_agentchat.ui import Console
            from sunagent_agentchat.messages import AgentEvent, ChatMessage
    ...
    component_provider_override = "sunagent_agentchat.teams.SelectorGroupChat"
