...
from sunagent_ext.memory import Mem0xMemoryConfig, Mem0xMemory, ProfileListMemoryConfig, ProfileListMemory
...
async def main():
    result: TaskResult = await agent.run(task="what is your name")
